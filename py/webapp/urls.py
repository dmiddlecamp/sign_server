...
#    url(r'^robertsTest/', include(robertsTest.urls.urlpatterns)),
    ...
    url(r'^peggy/2/clear/(?P<lease_code>.*)', 'sign_server.peggy.clear_board'),
    url(r'^peggy/2/write/(?P<lease_code>.*)/(?P<row>.*)/(?P<col>.*)/(?P<msg>.*)', 'sign_server.peggy.write'),
    url(r'^peggy/2/set_color/(?P<lease_code>.*)/(?P<color>.*)', 'sign_server.peggy.set_color'),
